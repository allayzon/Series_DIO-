...
namespace DIO.Series
{
    class Program
    {
        ...
        private static void AtualizarSerie()
        {
            ...
            Serie serieObtida = obterSerie();

            repositorio.Atualiza(indiceSerie, serieObtida);
        }
        ...
        private static void InserirSerie()
        {
            ...
            repositorio.Insere(serieObtida);
        }
        ...
        private static Serie obterSerie()
        {
            ...
            Serie serieObtida = new Serie(id: repositorio.ProximoId(),
        ...
        private static string ObterOpcaoUsuario()
        {
            ...
            System.Console.WriteLine("Informer a opção desejada:");
